...
void Device_Info(void){
  ...
  byte* longAddr = NLME_GetExtAddr();
    ...
    printf("协调器节点,短地址：%X %X 长地址:%X %X %X %X %X %X %X %X \r\n",shortAddr_byte[0],shortAddr_byte[1],
           longAddr[0], longAddr[1], longAddr[2], longAddr[3], longAddr[4], longAddr[5], longAddr[6], longAddr[7] );
  #elif defined(RTR_NWK) 
      printf("路由器节点,短地址：%X %X 长地址:%X %X %X %X %X %X %X %X \r\n",shortAddr_byte[0],shortAddr_byte[1],
           longAddr[0], longAddr[1], longAddr[2], longAddr[3], longAddr[4], longAddr[5], longAddr[6], longAddr[7] );
  #else
      printf("终端节点,短地址：%X %X 长地址:%X %X %X %X %X %X %X %X \r\n",shortAddr_byte[0],shortAddr_byte[1],
           longAddr[0], longAddr[1], longAddr[2], longAddr[3], longAddr[4], longAddr[5], longAddr[6], longAddr[7] );
  #endif
}
